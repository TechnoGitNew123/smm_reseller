      ...
      <form class="input_form" method="post" action="">
        <div class="row ">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="password" class="form-control form-control-sm" name="reseller_password" id="reseller_password" value="" placeholder="Enter Password" required="">
          </div>
          <div class="form-group col-md-6">
            <label>Confirm Password</label>
            <input type="password" class="form-control form-control-sm" id="reseller_c_password" value="" placeholder="Confirm Password" required="">
          </div>
