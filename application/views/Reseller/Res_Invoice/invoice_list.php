                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a  target="_blank" href="<?php echo base_url() ?>Reseller/Res_Invoice/admin_invoice_print/<?php echo $list->invoice_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-print text-primary"></i></a></td>
                        <!-- <td class="wt_50">
